...
def parse_config():
    ...
    parser.add_argument("--config", default="/root/autodl-tmp/MIENet/configs/MIENet/COD-MIENet.py", type=str)
    parser.add_argument("--datasets-info", default="/root/autodl-tmp/MIENet/configs/_base_/dataset/dataset_configs.json", type=str)
