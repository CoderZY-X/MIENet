...
def parse_config():
    ...
    parser.add_argument("--config", default="/root/autodl-tmp/ZoomNet-main/configs/zoomnet/cod_zoomnet.py", type=str)
    parser.add_argument("--datasets-info", default="/root/autodl-tmp/ZoomNet-main/configs/_base_/dataset/dataset_configs.json",
                        type=str)
    parser.add_argument("--model-name", type=str)
    parser.add_argument("--batch-size", type=int)
    parser.add_argument("--load-from", default='/root/autodl-tmp/glass/output/ZoomNet_BS12_LR0.08_E32_H384_W384_OPMsgd_OPGMfinetune_SCf3_AMP/pth/state_final.pth', type=str)
    parser.add_argument("--save-path", default='/root/autodl-tmp/完整/paper', type=str)
